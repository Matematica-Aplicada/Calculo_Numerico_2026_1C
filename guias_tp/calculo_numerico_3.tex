...
\item Interprete el resultado: ¿qué implica para una señal que tiene muy pocas frecuencias activas (t pequeño)? ¿Y para una que solo es no nula en muy pocos instantes (s pequeño)?
\end{enumerate}
\end{exercise}
