...
\bej
(De Fourier a la DFT)
Considere los coeficientes de Fourier en forma compleja $c_k = \frac{1}{2\pi} \int_0^{2\pi} f(x) e^{-ikx} \, dx$. Muestre que al aproximar la integral utilizando la regla de los trapecios compuesta con $N$ puntos $Q_N$ se obtiene Transformada Discreta de Fourier (DFT) de la secuencia de valores muestreados $f(x_j)$, salvo factores de normalización.
\fej
