...
\]
donde $\kappa(\cdot)$ denota el número de condición en norma 2. Concluya que resolver el problema de mínimos cuadrados vía QR es numéricamente más estable que vía las ecuaciones normales cuando $A$ está mal condicionada.
\end{exercise}
